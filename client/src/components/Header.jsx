...
const Header = () => {
  ...
  return (
    ...
    >
      ...
      >
        <p>
          Best text to AI Ghibli image generator
        </p>
        <img src={assets.star_icon} alt="" />
      </motion.div>

      
      <motion.h1 className='text-5xl max-w-[300px] sm:text-7xl sm:max-w-[590px] mx-auto mt-10 text-center'> Turn text to <span className='text-blue-600'
      initial={{opacity: 0}}
      animate={{opacity: 1}}  
      transition={{delay: 0.4, duration: 2}}
      >ghibli image</span>, in seconds
      </motion.h1>
      ...
      className='flex flex-wrap justify-centre mt-16 gap-3'>
        {Array(6).fill('').map((image, index)=>(
          <motion.img 
